...
class MatchingFragment : Fragment() {
    ...
    fun setButtonMatching(){
        fragmentMatchingBinding.apply {
            buttonMatchingDone.apply {
                ...
                setOnClickListener {
                    // 결제 프래그먼토가 보여져야한다
                    matchingPetsitterActivity.replaceFragment(MatchingPetsitterFragmentName.PAYMENT_FRAGMENT,true, true, null)
                }
            }
        }
    }
    ...
    inner class RecyclerMainAdapter : RecyclerView.Adapter<RecyclerMainAdapter.RecyclerMainViewHolder>(){
        ...
        override fun onBindViewHolder(holder: RecyclerMainViewHolder, position: Int) {
            holder.rowMatchingBinding.imageViewRowMatchingPetSitter.setImageResource(R.drawable.petsitter)
            ...
            holder.rowMatchingBinding.imageViewRowMatchingReviewButton.setOnClickListener {
                ...
                matchingPetsitterActivity.replaceFragment(MatchingPetsitterFragmentName.PETSITTER_INFO_FRAGMENT,true, true, null)
            }
