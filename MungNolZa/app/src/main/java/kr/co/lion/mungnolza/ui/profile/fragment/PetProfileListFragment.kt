...
class PetProfileListFragment : Fragment() {
    ...
    private fun settingRecyclerViewPetProfile(){
        fragmentPetProfileListBinding.apply {
...
//                addItemDecoration(deco)
    ...
    private inner class PetProfileRecyclerViewAdapter : RecyclerView.Adapter<PetProfileRecyclerViewAdapter.PetProfileViewHolder>(){
