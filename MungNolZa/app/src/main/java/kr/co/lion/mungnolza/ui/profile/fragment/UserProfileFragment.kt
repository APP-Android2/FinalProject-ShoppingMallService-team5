...
class UserProfileFragment : Fragment() {
    ...
    // 내 프로필 수정 버튼
    fun settingButtonEditUserProfile(){
        fragmentUserProfileBinding.apply {
    ...
    // 펫시터 찜 버튼
    fun settingButtonFollowPetSitter(){
        fragmentUserProfileBinding.apply {
    ...
    // 펫시터 모드 전환 버튼
    fun settingButtonPerSitterMode(){
        fragmentUserProfileBinding.apply {
