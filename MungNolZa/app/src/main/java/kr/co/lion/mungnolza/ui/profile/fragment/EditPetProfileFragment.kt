...
class EditPetProfileFragment : Fragment() {
    ...
    // 반려동물 성별 토글 버튼 상태
    var isToggleButtonEditPetGenderMaleSelected = false
    var isToggleButtonEditPetGenderFemaleSelected = false

    // 반려동물 중성화 토글 버튼 상태
    var isToggleButtonEditPetNeuteringYesSelected = false
    var isToggleButtonEditPetNeuteringNoSelected = false
    ...
    // 반려동물 중성화 여부 토글 버튼
    fun toggleButtonEditPetNeutering() {
        fragmentEditPetProfileBinding.apply {
            // 중성화 했어요
