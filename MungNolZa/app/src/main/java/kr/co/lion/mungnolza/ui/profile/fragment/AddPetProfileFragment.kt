...
class AddPetProfileFragment : Fragment() {
    ...
    private var isToggleButtonAddPetGenderMaleSelected = false
    private var isToggleButtonAddPetGenderFemaleSelected = false

    // AddPetNeutering 토글 버튼 상태
    private var isToggleButtonAddPetNeuteringYesSelected = false
    private var isToggleButtonAddPetNeuteringNoSelected = false
    ...
    // 반려동물 성별 토글 버튼
    private fun toggleButtonAddPetGender() {
        fragmentAddPetProfileBinding.apply {
            // 남자아이 버튼
    ...
    // 반려동물 중성화 여부 토글 버튼
    private fun toggleButtonAddPetNeutering() {
        fragmentAddPetProfileBinding.apply {
            // 했어요 버튼
