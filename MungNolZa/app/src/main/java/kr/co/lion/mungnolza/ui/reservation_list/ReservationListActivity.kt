...
class ReservationListActivity : AppCompatActivity() {
    ...
    lateinit var activityReservationListBinding : ActivityReservationListBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityReservationListBinding = ActivityReservationListBinding.inflate(layoutInflater)
        setContentView(activityReservationListBinding.root)

        replaceFragment(ReservationListFragmentName.RESERVATION_LIST_FRAGMENT, false, false, null)
    }
    ...
    fun replaceFragment(name: ReservationListFragmentName, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        if(newFragment != null){
            ...
            fragmentTransaction.replace(R.id.reservationListContainer, newFragment!!)
    ...
    fun removeFragment(name: ReservationListFragmentName){
        SystemClock.sleep(200)
