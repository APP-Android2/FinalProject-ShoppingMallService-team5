...
class ChatActivity : AppCompatActivity() {
    ...
    fun replaceFragment(name: ChatFragmentName, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        if(newFragment != null){
            ...
            fragmentTransaction.replace(R.id.fragmentContainerChat, newFragment!!)
    ...
    fun removeFragment(name: ChatFragmentName){
        SystemClock.sleep(200)
